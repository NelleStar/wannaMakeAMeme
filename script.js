...
form.addEventListener('submit', function(e) {
    ...
    const topLine = topText(textInputOne.value, colorInput.value, fontSizeInput.value);
    const bottomLine = bottomText(textInputTwo.value, colorInput.value, fontSizeInput.value);
